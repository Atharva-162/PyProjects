...
import pandas as pd
import os
for dirname, filenames in os.walk('C:/KLDD'):
...
df_train=pd.read_csv('C:/KLDD/ds/KDDTrain+.txt',header=None,names=columns)
df_test=pd.read_csv('C:/KLDD/ds/KDDTest+.txt',header=None,names=columns)
